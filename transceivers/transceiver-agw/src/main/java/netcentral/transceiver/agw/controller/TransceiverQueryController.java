package netcentral.transceiver.agw.controller;
...
import netcentral.transceiver.agw.accessor.TransceiverQueryAccessor;

@Controller("/api/v1/transceiverQueries") 
@Secured(SecurityRule.IS_ANONYMOUS) 
public class TransceiverQueryController {
    @Inject
