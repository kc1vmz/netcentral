...
public class TransceiverStatistics {
    private long objectsReceived;
    private long objectsSent;
    private long messagesSent;
    private long sourceReconnects;
    ...
    public TransceiverStatistics(){
    }

    public TransceiverStatistics(TransceiverStatistics statistics) {
        ...
        sourceReconnects = statistics.getSourceReconnects();
    ...
    public long getSourceReconnects() {
        return sourceReconnects;
    }
    public void setSourceReconnects(long sourceReconnects) {
        this.sourceReconnects = sourceReconnects;
    }
