...
@MappedEntity("aprs_position")
public record APRSPositionRecord(@Id @NonNull @NotBlank @Size(max = 36) String aprs_position_id, 
                                    ...
                                    @Nullable @Size(max = 10) String directivity,
