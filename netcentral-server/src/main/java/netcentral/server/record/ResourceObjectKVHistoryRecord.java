...
@MappedEntity("aprs_object_resource_history_kv")
public record ResourceObjectKVHistoryRecord(@Id @NonNull @NotBlank @Size(max = 36) String aprs_object_resource_kv_id,
                                ...
                                @NonNull @NotBlank ZonedDateTime created_time
) {  
}
