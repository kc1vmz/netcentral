...
@Singleton
public class FederatedObjectMessageIngestionAccessor {
    private static final Logger logger = LogManager.getLogger(FederatedObjectMessageIngestionAccessor.class);
