...
public class ObjectShelterCensusReport {
    ...
    public ObjectShelterCensusReport() {
    }
    public ObjectShelterCensusReport(String callsign, Integer population03, Integer population47, Integer population812, Integer population1318, Integer population1965, Integer population66, ZonedDateTime lastReportedTime) {
