...
To run the JAR file, specify:  
    java -Dmicronaut.environments=mysql -jar netcentral-server-1.0.25.jar
or
    java -Dmicronaut.environments=h2 -jar netcentral-server-1.0.25.jar
...
transceiver-agw-1.0.25.jar  
transceiver-aprsis-1.0.25.jar  
transceiver-kenwood-1.0.25.jar  
transceiver-kiss-1.0.25.jar  
transceiver-test-1.0.25.jar  
