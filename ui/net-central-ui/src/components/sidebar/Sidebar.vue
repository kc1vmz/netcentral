...
<template>
  <div v-if=(!isMobileClient()) class="sidebar" :style="{ width: sidebarWidth }">
    <span v-if="collapsed">
    </span>
    <span v-else>
  ...
  <div v-else class="sidebar" :style="{ width: sidebarWidth }">
    <span v-if="collapsed">
    </span>
    <span v-else>
      <div class="menuheader">Net Central</div>
    </span>
    <SidebarLink to="/homeMobile" icon="fas fa-home">Home</SidebarLink>
    <SidebarLink v-if="((loggedInUserToken != null) && (loggedInUserToken.value != null))" to="/dashboardMobile" icon="fa fa-tachometer">Dashboard</SidebarLink>
    <SidebarLink v-if="((loggedInUserToken != null) && (loggedInUserToken.value != null))" to="/monitorMobile" icon="fas fa-heartbeat">Net Monitor</SidebarLink>
    <div class="line"><hr/></div>
    <div v-if="((loggedInUserToken == null) || (loggedInUserToken.value == null))">
      <SidebarLink to="/login" icon="fa-solid fa-right-to-bracket">Login</SidebarLink>
      <SidebarLink to="/register" icon="fa-solid fa-pen-to-square">Register</SidebarLink>
